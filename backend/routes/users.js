...
//   "/",
//   protect,
//   authorizeRoles("admin", "manager", "marketing_manager"),
//   async (req, res) => {
//     try {
//       const loggedInUser = req.user;
//       const {
...
//       if (loggedInUser.role === "admin") {
//         if (
//           ["intern", "employee", "marketing_intern"].includes(role) &&
//           !manager
//         ) {
//           return res.status(400).json({
//             message: "Intern/Employee/Marketing Intern must have a manager",
//           });
//         }
...
//       if (loggedInUser.role === "marketing_manager") {
//         if (role !== "marketing_intern") {
//           return res.status(403).json({
//             message: "Marketing Manager can only add marketing interns",
//           });
//         }
...
// /* =====================================================
//    MANAGER / MARKETING MANAGER → GET OWN TEAM
// ===================================================== */
// router.get(
//   "/manager/interns",
//   protect,
//   authorizeRoles("manager", "marketing_manager"),
//   async (req, res) => {
//     try {
//       const users = await User.find({ manager: req.user._id })
//         .select("name email role teamName joiningDate");
...
//   "/",
//   protect,
//   authorizeRoles("admin", "manager", "marketing"),
//   async (req, res) => {
//     try {
//       const loggedInUser = req.user;
//       const {
...
//         if (["intern", "employee", "marketing"].includes(role) && !manager) {
//           return res.status(400).json({
//             message: "Intern/Employee/Marketing must have a manager",
//           });
//         }
...
//           role,
//           manager:
//             ["intern", "employee", "marketing"].includes(role)
//               ? manager
//               : null,
//           position: role === "employee" ? position : "",
//           teamName,
...
//       /* ========== MARKETING FLOW ========== */
//       if (loggedInUser.role === "marketing") {
//         if (role !== "intern") {
//           return res.status(403).json({
//             message: "Marketing can only add interns",
//           });
//         }
...
// /* =====================================================
//    MANAGER / MARKETING → GET OWN TEAM
// ===================================================== */
// router.get(
//   "/manager/interns",
//   protect,
//   authorizeRoles("manager", "marketing"),
//   async (req, res) => {
//     try {
//       const users = await User.find({ manager: req.user._id })
//         .select("name email role teamName joiningDate");
...
//           return res.status(403).json({
//             message:
//               "Managers can only add interns, employees or marketing",
//           });
//         }
...
// /* =====================================================
//    GET SINGLE USER PROFILE  ✅ (THIS WAS MISSING)
// ===================================================== */
// router.get("/:id", protect, async (req, res) => {
//   try {
//     const targetUser = await User.findById(req.params.id)
...
//     // Manager or Marketing can view their team
//     if (
//       ["manager", "marketing"].includes(req.user.role) &&
//       targetUser.manager?.toString() === req.user._id.toString()
//     ) {
//       return res.json(targetUser);
//     }
...
//     // ✅ Manager & Marketing can see only their team
//     if (
//       ["manager", "marketing"].includes(req.user.role) &&
//       targetUser.manager &&
//       targetUser.manager.toString() === req.user._id.toString()
...
router.get("/:id", protect, async (req, res) => {
  try {
    ...
    // Manager & Marketing can see their team
    if (
      ["manager", "marketing"].includes(req.user.role) &&
      targetUser.manager &&
      targetUser.manager._id.toString() === req.user._id.toString()
    ) {
      return res.json(targetUser);
    }
